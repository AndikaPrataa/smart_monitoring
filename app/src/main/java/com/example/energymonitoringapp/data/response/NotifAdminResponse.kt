...
data class NotifAdminResponse(
    ...
    @SerializedName("data") val data: List<NotifAdminItem?>? = null
)

data class NotifAdminItem(
    ...
    @SerializedName("technician") val technician: TechnicianStatusItem? = null,
    @SerializedName("timestamp") val timestamp: String? = null,
    @SerializedName("created_at") val createdAt: String? = null,
    @SerializedName("updated_at") val updatedAt: String? = null
)

data class DetailNotifAdminResponse(
    @SerializedName("success") val success: Boolean? = null,
    @SerializedName("message") val message: String? = null,
